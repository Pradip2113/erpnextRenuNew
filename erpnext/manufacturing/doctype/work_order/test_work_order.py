...
class TestWorkOrder(FrappeTestCase):
	# @frappe.whitelist()
	# def pcb_details(self):
	# 	doc1 = frappe.get_all('BOM',filters={'name':self.bom_no},fields=["name", "pcb_details",])
	# 	for i in doc1.get("pcb_details"):
	# 		frappe.msgprint(str(i.pcb_details))
